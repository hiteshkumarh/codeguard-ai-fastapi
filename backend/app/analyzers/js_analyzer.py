...
class JSAnalyzer(BaseAnalyzer):
    def analyze(self, code: str) -> List[Issue]:
        ...
        try:
            ...
            # Resolve paths based on the location of this file, not the working directory.
            # __file__ is backend/app/analyzers/js_analyzer.py
            # Root is three directories up (backend) then one more (root).
            backend_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
            root_dir = os.path.dirname(backend_dir)
            
            eslint_bin = os.path.join(root_dir, "js-analyzer", "node_modules", "eslint", "bin", "eslint.js")
            ...
            config_path = os.path.join(root_dir, "js-analyzer", "eslint.config.js")
